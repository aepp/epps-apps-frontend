...
export const StaticLinearProgress: React.FunctionComponent<Props> & {
    ...
    >
      {label && (
        <div className={ownClasses.labelContainer}>
          <Typography className={ownClasses.label} style={{...labelColorStyle}}>
            {label}
          </Typography>
        </div>
      )}
      <div
        className={`${ownClasses.progress} ${
          classes && classes.progress ? classes.progress : ''
        }`}
        style={{
